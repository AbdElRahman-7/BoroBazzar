...
import AuthLayout from "../../../auth/components/admin/AuthLayout";
import InputField from "../../../auth/components/admin/InputField";
import { forgotPasswordSchema, type ForgotPasswordSchema } from "../../../auth/lib/Validations";
import { forgotPassword } from "../../services/UseAuthApi";
      ...
      setTimeout(() => {
        navigate("/verify", {
          state: {
            ...
            flow: "forgot-password",   // ← tells VerifyOTPPage which flow we're in
          },
        });
      }, 1500);
    },
