...
import AuthLayout from "../../../../features/auth/components/admin/AuthLayout";
import { verifyOTP, verifyForgotPasswordOTP } from "../../services/UseAuthApi";
...
const VerifyOTPPage = () => {
  ...
  // "register" | "forgot-password"  — defaults to register
  const flow: "register" | "forgot-password" =
    (location.state as any)?.flow || "register";
  ...
  const { mutate, isPending } = useMutation({
    mutationFn: flow === "forgot-password" ? verifyForgotPasswordOTP : verifyOTP,
    onSuccess: () => {
      if (flow === "forgot-password") {
        setServerSuccess("OTP verified! Redirecting to reset password…");
